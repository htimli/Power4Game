...
public class Puissance4Impl implements Puissance4 {
	...
	public boolean diagTopLeft(int i, int col, P4Player p){           //diagonal  \
		int diagCount = 1;
	...
	public boolean diagTopRight(int i, int col, P4Player p) {       //diagonal  /
		int diagCount = 1;
	...
	public boolean testWin(int i, int col) {
		...
		if(diagTopRight(i, col, p) || diagTopLeft(i, col, p) ||
